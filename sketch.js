...
function showArrows(index, arrows) {
  ...
  if(
    ...
    arrows[index].body.position.y > height
      ...
      if(!arrows[index].idRemoved){
        arrows[index].removed(index,arrows)
      }else{
        arrows[index].treajectory=[]
      }
    }
